-- FINAL CORRECTED SQL - Matches actual layers table schema
...
-- STEP 2: Create the polygon layer (FINAL CORRECT VERSION)
-- Only includes columns that exist: project_id, name, geom_type, srid
...
GROUP BY l.id, l.name, l.geom_type, l.srid;
...
-- STEP 6: After running above, refresh browser (Ctrl+F5)
-- The polygon layer should now appear in the dropdown!
