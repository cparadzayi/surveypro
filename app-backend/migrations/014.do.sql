-- Migration 014: Create land_parcels table for storing calculated parcels per project
-- Each parcel belongs to a project and contains boundary points and calculated area
