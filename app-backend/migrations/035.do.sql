...
-- Creates function to dynamically generate project-specific views with LISTEN/NOTIFY

BEGIN;

-- Drop existing functions if they exist (handles return type changes)
...
-- ============================================================================
-- FUNCTION: Create project-specific views dynamically
-- ============================================================================
...
-- ============================================================================
-- FUNCTION: Drop project-specific views
-- ============================================================================

CREATE OR REPLACE FUNCTION drop_project_views(p_project_id INTEGER)
RETURNS jsonb AS $$
DECLARE
  v_coord_view_name TEXT;
  v_parcel_view_name TEXT;
...
-- ============================================================================
-- FUNCTION: List all project views
-- ============================================================================

CREATE OR REPLACE FUNCTION list_project_views()
RETURNS TABLE (
  project_id INTEGER,
  coordinate_view TEXT,
  parcel_view TEXT
) AS $$
BEGIN
  RETURN QUERY
