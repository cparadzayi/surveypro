-- Migration 049: Fix - both public and surveyor schemas use closure_error_m
...
BEGIN
  ...
  -- BOTH public and surveyor schemas use closure_error_m!
  EXECUTE format('
...
SELECT '✅ Migration 049: FINAL FIX - Both schemas use closure_error_m column' AS status;
