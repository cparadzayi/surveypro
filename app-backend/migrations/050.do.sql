-- Migration 050: Skip workflow_states migration (table doesn't exist in surveyor schema yet)
...
BEGIN
  ...
  -- Workflow data will stay in public.workflow_states for now
...
COMMENT ON FUNCTION migrate_surveyor_to_schema IS 'Migrates surveyor data from public to surveyor schema (excluding workflow_states)';

SELECT '✅ Migration 050: Removed workflow_states migration (table not in surveyor schema)' AS status;
