 ...
 *
 * This used to be asserted against two renderers, because utils/pdf-generator.ts
 * held a second field-book renderer that carried the same defect. That renderer
 * is gone: the View/Download Field Book buttons now use the one asserted here,
 * so there is no second implementation left to drift.
 */
